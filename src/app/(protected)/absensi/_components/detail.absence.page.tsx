"use client";
import BodyContent from "@/components/shared/layout/body-content";
...
function DetailAbsence() {
  ...
  return (
    <BodyContent title="Detail Absen">
      <div className="bg-white rounded border p-4 mb-3 grid grid-cols-2 gap-y-3">
        ...
        <div className="space-y-2">
          ...
          <p>{absence?.data?.masuk?.split(":").slice(0, 2).join(":") || "-"}</p>
        </div>
        <div className="space-y-2">
      ...
      <div className="border">
        {marker.length && (
          ...
          >
            ...
            <Marker icon={blueIcon} position={markerOut as LatLngExpression} />
          </MapContainer>
        )}
      </div>
